...
- [OpenProse](https://github.com/openprose/prose) - Declarative Markdown contracts for multi-agent AI sessions — write a `.prose.md` file, and the agent wires services, runs subagents, and leaves an auditable trace.
